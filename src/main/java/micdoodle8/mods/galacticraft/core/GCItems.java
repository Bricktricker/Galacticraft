...
public class GCItems {
	...
	public static final RegistryObject<ItemOxygenTank> OX_TANK_HEAVY = ITEMS.register(ItemNames.oxTankHeavy, () -> new ItemOxygenTank(1, defaultBuilder().maxDamage(2700)));
