...
public class ItemNames
{
    ...
    public static final String buggySeat = "buggy_seat";
    public static final String buggyStorage = "buggy_storage";
    public static final String buggyWheel = "buggy_wheel";
    public static final String burgerBun = "burger_bun";
    public static final String copperCanister = "copper_canister";
    public static final String tinCanister = "tin_canister";
    ...
    public static final String advancedWafer = "advanced_wafer";
    public static final String basicWafer = "basic_wafer";
