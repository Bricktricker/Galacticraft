...
public class GuiNewSpaceRace extends GuiScreen implements ICheckBoxCallback, ITextBoxCallback
{
        ...
        if (this.initialized)
        {
            ...
            switch (this.currentState)
            {
                ...
                case ADD_PLAYER:
                    ...
                    int xPos0 = ((GuiElementGradientButton) this.buttonList.get(0)).x + this.buttonList.get(0).getButtonWidth() + 10;
                ...
                case REMOVE_PLAYER:
                    ...
                    int xPos0b = ((GuiElementGradientButton) this.buttonList.get(0)).x + this.buttonList.get(0).getButtonWidth() + 10;
                ...
                case DESIGN_FLAG:
                    ...
                    this.flagDesignerMinX = this.width / 2F - this.spaceRaceData.getFlagData().getWidth() * (float) this.flagDesignerScale.x / 2;
                    this.flagDesignerMinY = this.height / 2F - this.spaceRaceData.getFlagData().getHeight() * (float) this.flagDesignerScale.y / 2;
    ...
    public void updateScreen()
    {
        ...
        if (this.currentState == EnumSpaceRaceGui.ADD_PLAYER && this.gradientListAddPlayers != null && this.ticksPassed % 20 == 0)
        {
            ...
            {
                EntityPlayer player = this.thePlayer.world.playerEntities.get(i);
        ...
        if (this.initialized)
        {
            ...
            switch (this.currentState)
            {
                ...
                case CHANGE_TEAM_COLOR:
                    ...
                    y1 = this.height / 2F - this.height / 3F + 5;
                    ...
                    if (xDiff > yDiff)
                    {
                        x1 = this.sliderColorG.x + this.sliderColorG.getButtonWidth() / 2F - yDiff / 2;
                        x2 = this.sliderColorG.x + this.sliderColorG.getButtonWidth() / 2F + yDiff / 2;
                    } else
                    {
                        y2 = y1 + xDiff;
                    }
    ...
    private void drawFlagButton()
    {
        ...
        if (this.canEdit)
        {
            ...
            this.fontRenderer.drawString(message, this.buttonFlag_xPosition + this.buttonFlag_width / 2F - this.fontRenderer.getStringWidth(message) / 2F, this.buttonFlag_yPosition + this.buttonFlag_height / 2F - 5, ColorUtil.to32BitColor(255, color, color, color), this.buttonFlag_hover);
        }
        GL11.glPopMatrix();
    ...
    private void drawColorButton()
    {
        ...
        if (canEdit)
        {
            this.fontRenderer.drawString(GCCoreUtil.translate("gui.space_race.create.change_color.name.0"), this.buttonTeamColor_xPosition + this.buttonTeamColor_width / 2F - this.fontRenderer.getStringWidth(GCCoreUtil.translate("gui.space_race.create.change_color.name.0")) / 2F, this.buttonTeamColor_yPosition + this.buttonTeamColor_height / 2F - 13, ColorUtil.to32BitColor(255, color, color, color), this.buttonTeamColor_hover);
        }
        this.fontRenderer.drawString(GCCoreUtil.translate("gui.space_race.create.change_color.name.1"), this.buttonTeamColor_xPosition + this.buttonTeamColor_width / 2F - this.fontRenderer.getStringWidth(GCCoreUtil.translate("gui.space_race.create.change_color.name.1")) / 2F, this.buttonTeamColor_yPosition + this.buttonTeamColor_height / 2F - (canEdit ? 3 : 9), ColorUtil.to32BitColor(255, color, color, color), this.buttonTeamColor_hover);
        this.fontRenderer.drawString(GCCoreUtil.translate("gui.space_race.create.change_color.name.2"), this.buttonTeamColor_xPosition + this.buttonTeamColor_width / 2F - this.fontRenderer.getStringWidth(GCCoreUtil.translate("gui.space_race.create.change_color.name.2")) / 2F, this.buttonTeamColor_yPosition + this.buttonTeamColor_height / 2F + (canEdit ? 7 : 1), ColorUtil.to32BitColor(255, color, color, color), this.buttonTeamColor_hover);
        GL11.glPopMatrix();
