...
//    }
    ...
    public void tick()
    {
        ...
        if (!this.world.isRemote && this.getHealth() <= 150.0F * ConfigManagerCore.INSTANCE.dungeonBossHealthMod.get() / 2)
        {
...
//    } TODO Item drops
    ...
    public void dropKey()
    {
        this.entityDropItem(new ItemStack(GCItems.KEY.get(), 1), 0.5F);
    }
