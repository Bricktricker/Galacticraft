...
public class GCContainerNames
{
    ...
    public static final String EXTENDED_INVENTORY = "extended_inventory";
    ...
    public static final String ROCKET_INVENTORY = "inventory";
    public static final String SCHEMATIC = "schematic";
    public static final String SCHEMATIC_T1_ROCKET = "schematic_t1_rocket";
