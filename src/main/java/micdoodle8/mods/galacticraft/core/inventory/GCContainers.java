...
public class GCContainers
{
    ...
    public static void initContainers(RegistryEvent.Register<ContainerType<?>> evt)
    {
        ...
        ContainerType<CargoLoaderContainer> cargoLoader = IForgeContainerType.create((windowId, inv, data) -> new CargoLoaderContainer(windowId, inv, (CargoBaseTileEntity) inv.player.world.getTileEntity(new BlockPos(data.readInt(), data.readInt(), data.readInt()))));
        ...
        ContainerType<DeconstructorContainer> deconstructor = IForgeContainerType.create((windowId, inv, data) -> new DeconstructorContainer(windowId, inv));
