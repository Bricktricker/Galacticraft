...
public class ClientProxyCore extends CommonProxyCore implements IResourceManagerReloadListener
{
    ...
    public static void registerEntityRenderers()
    {
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityAlienVillager.class, RenderAlienVillager::new);
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityBuggy.class, RenderBuggy::new);
    ...
    public void init(FMLInitializationEvent event)
    {
        ...
        Minecraft.getMinecraft().getBlockColors().registerBlockColorHandler(
                (state, world, pos, tintIndex) ->
                        BlockFallenMeteor.colorMultiplier(world, pos), GCBlocks.fallenMeteor);
