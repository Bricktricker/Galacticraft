...
public class CompatModuleIC2
{
    public static void addIndustrialCraft2Recipes()
    {
        ...
        Recipes.centrifuge.addRecipe(Recipes.inputFactory.forStack(new ItemStack(GCItems.ic2compat, 1, 1), 1), heatTag1, false, dustSmallTitanium, new ItemStack(GCItems.ic2compat, 1, 0));
        NBTTagCompound heatTag2 = new NBTTagCompound();
        heatTag2.setInteger("minHeat", 750);
        Recipes.centrifuge.addRecipe(Recipes.inputFactory.forStack(new ItemStack(GCItems.ic2compat, 1, 2), 1), heatTag1, false, dustSmallIron, new ItemStack(GCItems.ic2compat, 1, 0), dustStone);
        dustSmallIron = dustSmallIron.copy();
        dustSmallIron.setCount(2);
        Recipes.oreWashing.addRecipe(Recipes.inputFactory.forStack(new ItemStack(GCItems.ic2compat, 1, 2), 1), amountTag, false, new ItemStack(GCItems.ic2compat, 1, 1), dustSmallIron, dustStone);
