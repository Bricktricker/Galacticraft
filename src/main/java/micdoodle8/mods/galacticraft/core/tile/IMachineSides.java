...
public interface IMachineSides extends ITileClientUpdates
{
     ...
     */
    static IBlockState addPropertyForTile(IBlockState state, TileEntity tile, IMachineSidesProperties renderType, PropertyEnum<MachineSidesModel> key)
    {
    ...
    default void addMachineSidesToNBT(NBTTagCompound par1nbtTagCompound)
    {
    ...
    default void readMachineSidesFromNBT(NBTTagCompound par1nbtTagCompound)
    {
