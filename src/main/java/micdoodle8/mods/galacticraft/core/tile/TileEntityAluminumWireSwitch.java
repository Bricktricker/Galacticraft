...
public class TileEntityAluminumWireSwitch extends TileBaseUniversalConductor
{
    ...
    {
        return !this.disableConnections() && super.acceptsEnergyFrom(emitter, side);
    }
    ...
    {
        return !this.disableConnections() && super.emitsEnergyTo(receiver, side);
    }
    ...
    {
        return !this.disableConnections() && super.canConnectEnergy(from);
    }
    ...
    {
        return !this.disableConnections() && super.canReceiveEnergy(side);
    }
}
