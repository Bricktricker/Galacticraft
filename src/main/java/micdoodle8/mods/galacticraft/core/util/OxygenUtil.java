...
public class OxygenUtil
{
    ...
    public static boolean isAABBInBreathableAirBlock(LivingEntity entity, boolean testThermal)
    {
        ...
        if (entity.world.getBlockState(entity.getPosition()).getBlock() == null) //'null' was 'GCBlocks.airLockSeal'
        {
            offsetXZ = 0.75F;
        }
    ...
    {
        checked.add(pos);
        if (block == GCBlocks.BREATHEABLE_AIR.get() || block == GCBlocks.BRIGHT_BREATHEABLE_AIR.get())
        {
